...
export class ListaPage implements OnInit {
  ...
  public talho: any;
  public frutas: any;
  public charcutaria: any;
  public outros: any;
  public laticinios: any;
  public peixaria: any;
  public legumes: any;
  public padaria: any;
  ...
  async receberListas() {
    ...
    this.authService.getProducts().subscribe(res => {
      ...
      //Tabela Frutas
      this.frutas = this.allProducts.filter(function (produto) {
      ...
      this.bebidas = this.allProducts.filter(function (produto) {
       ...
       //Tabela Padaria
       this.padaria = this.allProducts.filter(function (produto) {
        return produto.categoria == 'Padaria';
      })

       //Tabela Legumes
       this.legumes = this.allProducts.filter(function (produto) {
        return produto.categoria == 'Legumes';
      })

      
      //Tabela Peixaria
      this.peixaria = this.allProducts.filter(function (produto) {
        return produto.categoria == 'Peixaria';
      })

      //Tabela Laticínios
      this.laticinios = this.allProducts.filter(function (produto) {
        return produto.categoria == 'Laticínios';
      })
      ...
      //Tabela Charcutaria
      this.charcutaria = this.allProducts.filter(function (produto) {
        return produto.categoria == 'Charcutaria';
      })
     
      //Tabela Outros
      this.outros = this.allProducts.filter(function (produto) {
